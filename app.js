...
// It consoles joes profile as a student, including joes name, age, and hometown.

// 2. What is "this" when joe.scopeArrow() is invoked?
// The console notes the window a couple times, and only gives joes name along with document.

// 3. Explain why "this" is different when an arrow function is used.
// "this" doesn't have its own value within an arrow function, and so I think it has to do with the surrounding scope of the function.